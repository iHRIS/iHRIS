<template>
  <div :id="'section-'+id" class="ihris-section">
    <v-card 
      class="mx-auto"
      max-width="700"
      outlined
      >
      <v-card-title class="primary darken-1 white--text text-uppercase font-weight-bold">{{ $t(`App.ihris-questionnaire-section.${label}`) }}</v-card-title>
