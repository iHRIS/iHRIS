...
export default {
  name: "fhir-reference-report",
  props: ["field", "label", "sliceName", "targetProfile", "targetResource", "min", "max", "base-min", "base-max",
    "slotProps", "path", "sub-fields", "edit", "readOnlyIfSet", "constraints", "initialValue", "overrideValue","returnAll"],
  components: {},
  data: function () {
    return {
      source: {path: "", data: {}},
  ...
  watch: {
    ...
    selected: function (val) {
      ...
      this.$emit("selectedFacility", value)
    },
    select: function (val) {
