  ...
  >
    ...
    >
      ...
      >
        ...
        <v-list-item
          to="/resource/search/practitioner"
        ...
        <v-list-item
          to="/questionnaire/ihris-practitioner/practitioner"
          active-class="primary darken-2"
          class="text-right"
          dense
        >
      ...
      >
        ...
        <v-list-item
          to="/resource/search/practitionerrole"
          active-class="primary darken-2"
          class="text-right"
          dense
        >
...
export default {
  ...
  methods: {
    ...
    setMhero: function() {
      this.mhero = !this.mhero;
      if (this.mhero) {
        this.mheroClass = "primary darken-2";
      } else {
        this.mheroClass = "";
      }
    }
