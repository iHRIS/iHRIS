        ...
        if ( req.body && req.body.item 
          ...
          && req.body.item[0].item[0].answer && req.body.item[0].item[0].answer[0]) {
            ...
            if ( req.body.item[0].item[1].linkId === "Basic.extension[0].extension[1]" 
                ...
                complexExt.push({ url: "indexNumber",
            ...
            if ( req.body.item[0].item[2].linkId === "Basic.extension[0].extension[2]" 
                ...
                complexExt.push({ url: "intakeDate",
            ...
            if ( req.body.item[0].item[3].linkId === "Basic.extension[0].extension[3]" 
                ...
                complexExt.push({ url: "gradDate",
                valueDate:req.body.item[0].item[3].answer[0].valueDate })
            }
            if(complexExt){
                extensions.push({ url: "http://ihris.org/fhir/StructureDefinition/ihris-training",
                extension: complexExt})
            }
          let newTraining = {
            resourceType: "Basic",
            meta: {
              profile: [ "http://ihris.org/fhir/StructureDefinition/ihris-basic-training" ]
            },
            extension: extensions,
          }

          bundle.entry.push( {
            resource: newTraining,
            request: {
              method: "POST",
              url: "Basic"
            }
...
module.exports = workflowTraining
