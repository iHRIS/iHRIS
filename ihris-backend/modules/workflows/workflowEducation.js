        ...
        if ( req.body && req.body.item 
          ...
          && req.body.item[0].item[0].answer && req.body.item[0].item[0].answer[0]) {
            ...
            if ( req.body.item[0].item[2].linkId === "Basic.extension[0].extension[1]" 
                ...
                complexExt.push({ url: "academicLevel",
            ...
            if(complexExt){
                extensions.push({ url: "http://ihris.org/fhir/StructureDefinition/ihris-education",
                extension: complexExt})
            }
          let newEducation = {
            resourceType: "Basic",
            meta: {
              profile: [ "http://ihris.org/fhir/StructureDefinition/ihris-basic-education" ]
            },
            extension: extensions,
          }

          bundle.entry.push( {
            resource: newEducation,
            request: {
              method: "POST",
              url: "Basic"
            }
...
module.exports = workflowEducation
