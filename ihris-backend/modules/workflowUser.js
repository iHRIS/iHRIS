              ...
              //Health worker field field only for self service role(maybe do this on frontend)
                if (location && location != undefined) {
                  try {
                    ...
                    console.log(err)
                    winston.error(
                      "Error Getting user roles for user" +
                        userName
                    );
                    resolve(
                  ...
                  if (userRoles.entry) {
                    ...
                    try {
                      ...
                      console.log(error)
                      winston.error(
                        "Error creating new role for " + locationValueReference
                      );
                      resolve(
                        await workflowUser.outcome(
                          "Error creating new role for " +
                            locationValueReference
                        )
                      );
                    }
              ...
              },
              {
                ...
                extension: [
                  ...
                  },
                  {
                    url: "constraint",
                    valueString:
                      "extension.where(url = 'http://ihris.org/fhir/StructureDefinition/ihris-related-group' ).extension.exists( url = 'location' and valueString = '" +
                      locationReference +
                      "')",
                  },
                ],
