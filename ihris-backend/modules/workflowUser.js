      ...
      try {
        ...
        user.lookupByEmail(userEmail).then(async (userObj) => {
          if (!userObj) {
            ...
            if (req.body.item[0].item.find((item) => item.linkId === "location")) {

              try {
                userRoles = await fhirAxios.search("Basic", { locationconstraint: "related-location=" + req.body.item[0].item.find((item) => item.linkId === "location").answer[0].valueReference })
              } catch (err) {
              ...
              let locationValueReference = req.body.item[0].item.find((item) => item.linkId === "location").answer[0].valueReference.reference
              ...
              extensions.push({
                ...
                valueReference: req.body.item[0].item.find((item) => item.linkId === "location").answer[0].valueReference
              })
            ...
            if (req.body.item[0].item.find((item) => item.linkId === "role")) {
            ...
            if (req.body.item[0].item.find((item) => item.linkId === "password")) {
