        ...
        user.lookupByEmail(userEmail).then(async (userObj) => {
          if (!userObj) {
            ...
            if (req.body.item[0].item.find((item) => item.linkId === "role") !== undefined
              && req.body.item[0].item.find((item) => item.linkId === "role").answer
              && req.body.item[0].item.find((item) => item.linkId === "role").answer[0]
              && req.body.item[0].item.find((item) => item.linkId === "role").answer[0].valueReference) {
              extensions.push({
                url: "http://ihris.org/fhir/StructureDefinition/ihris-assign-role",
                valueReference: req.body.item[0].item.find((item) => item.linkId === "role").answer[0].valueReference
              })
            }
            ...
            if (req.body.item[0].item.find((item) => item.linkId === "group") !== undefined) {
              ...
              if (group.answer && group.answer[0] && group.answer[0].valueReference) {
                extensions.push({
                  url: "http://ihris.org/fhir/StructureDefinition/ihris-user-group",
                  valueReference: group.answer[0].valueReference
                })
              }
            }
            ...
            // password item
            if (req.body.item[0].item.find((item) => item.linkId === "password") !== undefined
              && req.body.item[0].item.find((item) => item.linkId === "password").answer
              && req.body.item[0].item.find((item) => item.linkId === "password").answer[0]
              && req.body.item[0].item.find((item) => item.linkId === "password").answer[0].valueString) {


              console.log("password", req.body.item[0].item.find((item) => item.linkId === "password"))
