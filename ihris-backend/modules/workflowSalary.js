        ...
        if ( req.body && req.body.item 
          ...
          && req.body.item[0].item[0].answer && req.body.item[0].item[0].answer[0]) {
            ...
            if ( req.body.item[0].item[0].linkId === "Basic.extension[0].extension[0]" 
                ...
                complexExt.push({ url: "salaryScale",
            ...
            if ( (req.body.item[0].item[4].linkId === "Basic.extension[0].extension[4]" 
                ...
                req.body.item[0].item[5].linkId === "Basic.extension[0].extension[5]" 
            ...
            if ( req.body.item[0].item[7].linkId === "Basic.extension[0].extension[7]" 
                ...
                complexExt.push({ url: "salarySource",
            ...
            if(complexExt){
                extensions.push({ url: "http://ihris.org/fhir/StructureDefinition/ihris-salary",
                extension: complexExt})
            }
          let newSalary = {
            resourceType: "Basic",
            meta: {
              profile: [ "http://ihris.org/fhir/StructureDefinition/ihris-basic-salary" ]
            },
