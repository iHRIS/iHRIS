...
* item[0].item[0].definition = "http://ihris.org/fhir/StructureDefinition/ihris-basic-inservice-training#Basic.extension:inservicetraining.extension:provider.value[x]"
...
* item[0].item[1].definition = "http://ihris.org/fhir/StructureDefinition/ihris-basic-inservice-training#Basic.extension:inservicetraining.extension:training.value[x]"
...
* item[0].item[2].definition = "http://ihris.org/fhir/StructureDefinition/ihris-basic-inservice-training#Basic.extension:inservicetraining.extension:courseName.value[x]"
...
* item[0].item[3].definition = "http://ihris.org/fhir/StructureDefinition/ihris-basic-inservice-training#Basic.extension:inservicetraining.extension:credits.value[x]"
...
* item[0].item[4].definition = "http://ihris.org/fhir/StructureDefinition/ihris-basic-inservice-training#Basic.extension:inservicetraining.extension:startDate.value[x]"
...
* item[0].item[5].definition = "http://ihris.org/fhir/StructureDefinition/ihris-basic-inservice-training#Basic.extension:inservicetraining.extension:endDate.value[x]"
