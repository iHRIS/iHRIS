...
* extension[reportdetails].extension[reportelement][0].extension[name].valueString = "employeeId"
* extension[reportdetails].extension[reportelement][0].extension[fhirpath].valueString = "identifier.where(type.coding.where(code='employeeId')).value"
...
* extension[reportdetails].extension[reportelement][4].extension[name].valueString = "given"
* extension[reportdetails].extension[reportelement][4].extension[fhirpath].valueString = "name.where(use='official').first().given"
...
* extension[reportdetails].extension[reportelement][5].extension[fhirpath].valueString = "gender"
