...
* extension[performance].extension[startDate].valueDate MS
* extension[performance].extension[startDate] ^label = "Evaluation Period Start Date"
* extension[performance].extension[endDate].valueDate MS
* extension[performance].extension[endDate] ^label = "Evaluation Period End Date"
...
* extension[startDate].valueDate ^label = "Evaluation Period Start Date"
* extension[endDate].value[x] only date
* extension[endDate].valueDate ^label = "Evaluation Period End Date"
* extension[score].value[x] only Coding
* extension[score].valueCoding ^label = "Score Attained"
* extension[score].valueCoding from http://ihris.org/fhir/ValueSet/ihris-performance-score-valueset (required)
...
* item[0].item[0].item[0].text = "Evaluator's Name"
* item[0].item[0].item[0].type = #string
* item[0].item[0].item[0].required = true
* item[0].item[0].item[0].repeats = false

* item[0].item[0].item[1].linkId = "Basic.extension[0].extension[1]"
* item[0].item[0].item[1].definition = "http://ihris.org/fhir/StructureDefinition/ihris-basic-performance#Basic.extension:performance.extension:startDate.value[x]:valueDate"
* item[0].item[0].item[1].text = "Evaluation Period Start Date"
* item[0].item[0].item[1].type = #date
* item[0].item[0].item[1].required = true
* item[0].item[0].item[1].repeats = false

* item[0].item[0].item[2].linkId = "Basic.extension[0].extension[2]"
* item[0].item[0].item[2].definition = "http://ihris.org/fhir/StructureDefinition/ihris-basic-performance#Basic.extension:performance.extension:endDate.value[x]:valueDate"
* item[0].item[0].item[2].text = "Evaluation Period End Date"
...
* item[0].item[0].item[3].definition = "http://ihris.org/fhir/StructureDefinition/ihris-basic-performance#Basic.extension:performance.extension:score.value[x]:valueCoding"
* item[0].item[0].item[3].text = "Score Attained"
* item[0].item[0].item[3].type = #choice
* item[0].item[0].item[3].answerValueSet = "http://ihris.org/fhir/ValueSet/ihris-performance-score-valueset"
...
* extension[section][0].extension[field][2].valueString = "Basic.extension:performance.extension:startDate.value[x]:valueDate"
* extension[section][0].extension[field][3].valueString = "Basic.extension:performance.extension:endDate.value[x]:valueDate"
* extension[section][0].extension[field][4].valueString = "Basic.extension:performance.extension:score.value[x]:valueCoding"
