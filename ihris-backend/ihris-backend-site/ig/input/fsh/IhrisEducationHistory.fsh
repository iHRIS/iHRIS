...
* item[0].item[0].item[0].text = "Education Institution"
...
* item[0].item[0].item[1].text = "Education Level"
...
* item[0].item[0].item[2].definition = "http://ihris.org/fhir/StructureDefinition/ihris-basic-education-history#Basic.extension:educationHistory.extension:degree.value[x]:valueCoding"
* item[0].item[0].item[2].text = "Degree"
* item[0].item[0].item[2].type = #choice
* item[0].item[0].item[2].answerValueSet = "http://ihris.org/fhir/ValueSet/ihris-degree-valueset"
...
* item[0].item[0].item[3].definition = "http://ihris.org/fhir/StructureDefinition/ihris-basic-education-history#Basic.extension:educationHistory.extension:educationalMajor.value[x]:valueCoding"
* item[0].item[0].item[3].text = "Education Major"
* item[0].item[0].item[3].type = #choice
* item[0].item[0].item[3].answerValueSet = "http://ihris.org/fhir/ValueSet/ihris-educational-major-valueset"
...
* item[0].item[0].item[4].definition = "http://ihris.org/fhir/StructureDefinition/ihris-basic-education-history#Basic.extension:educationHistory.extension:year.value[x]:valueDate"
* item[0].item[0].item[4].text = "Year Of Graduation"
...
* item[0].item[0].item[5].definition = "http://ihris.org/fhir/StructureDefinition/ihris-basic-education-history#Basic.extension:educationHistory.extension:current.value[x]:valueBoolean"
* item[0].item[0].item[5].text = "Is Current?"
...
* item[0].item[0].item[6].definition = "http://ihris.org/fhir/StructureDefinition/ihris-basic-education-history#Basic.extension:educationHistory.extension:attachment.value[x]:valueAttachment"
* item[0].item[0].item[6].text = "Attachement"
* item[0].item[0].item[6].type = #attachment
