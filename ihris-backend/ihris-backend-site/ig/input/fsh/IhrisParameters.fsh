...
* parameter[=].part[=].valueString = "TCHAD Ministry of Health"
* parameter[=].part[+].name = "site:site"
* parameter[=].part[=].valueString = "Human Resource Information System"
...
* parameter[=].part[+].name = "defaults:components:date:format"
* parameter[=].part[=].valueString = "YYYY-MM-DD"
* parameter[=].part[+].name = "defaults:components:date-time:format"
* parameter[=].part[=].valueString = "YYYY-MM-DD"
* parameter[=].part[+].name = "defaults:components:ihris-search:format"
* parameter[=].part[=].valueString = "YYYY-MM-DD"
* parameter[=].part[+].name = "defaults:components:ihris-secondary:format"
* parameter[=].part[=].valueString = "YYYY-MM-DD"
