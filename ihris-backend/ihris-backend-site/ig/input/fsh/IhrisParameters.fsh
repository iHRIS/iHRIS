...
* parameter[=].part[+].name = "site:nav:menu:database:menu:training:text"
* parameter[=].part[=].valueString = "In-Service Training Type/Category"
* parameter[=].part[+].name = "site:nav:menu:database:menu:training:url"
* parameter[=].part[=].valueString = "/resource/search/training"
* parameter[=].part[+].name = "site:nav:menu:database:menu:training:order"
* parameter[=].part[=].valueString = "18"
