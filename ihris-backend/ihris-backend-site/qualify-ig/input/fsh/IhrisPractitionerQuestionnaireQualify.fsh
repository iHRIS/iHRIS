...
* item[2].item[0].text = "Identifier"
* item[2].item[0].type = #group
* item[2].item[0].repeats = true
* item[2].item[0].required = false

* item[2].item[0].item[0].linkId = "Practitioner.identifier[0].system"
* item[2].item[0].item[0].definition = "http://ihris.org/fhir/StructureDefinition/ihris-practitioner#Practitioner.identifier.system"
* item[2].item[0].item[0].text = "System"
...
* item[2].item[0].item[1].text = "ID Number"
* item[2].item[0].item[1].type = #string
* item[2].item[0].item[1].repeats = false
* item[2].item[0].item[1].required = false

* item[2].item[0].item[2].linkId = "Practitioner.identifier[0].type"
* item[2].item[0].item[2].definition = "http://ihris.org/fhir/StructureDefinition/ihris-practitioner#Practitioner.identifier.type"
* item[2].item[0].item[2].text = "ID Type"
* item[2].item[0].item[2].type = #choice
* item[2].item[0].item[2].answerValueSet = "http://hl7.org/fhir/ValueSet/identifier-type"
