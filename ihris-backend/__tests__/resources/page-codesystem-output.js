module.exports =     {
  search: '<ihris-search :key="$route.params.page" page="test-codesystem" label="iHRIS Test CodeSystem" :fields="fields" :terms="terms" profile="//ihris.org/fhir/CodeSystem/ihris-test-codesystem">\n' +
  '</ihris-search>\n',
  searchData: [ [ 'Property One', 'prop1' ], [ 'Property Two', 'prop2' ] ],
  template: `<ihris-resource :fhir-id="fhirId" :edit="isEdit" v-on:setEdit="setEdit($event)" profile="//ihris.org/fhir/CodeSystem/ihris-test-codesystem" :key="$route.params.page+($route.params.id || '')" page="test-codesystem" field="CodeSystem" title="Test CodeSystem"><template #default="slotProps">\n` +
