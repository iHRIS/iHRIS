...
describe( 'Test FHIR Questionnaire processing', () => {
  ...
  const MOCK_QUESTIONNAIRE = require("./resources/Questionnaire-ihris-test")

  const STRUCTUREDEFINITION_PRACTITIONER = require("./resources/StructureDefinition-Practitioner")
  const STRUCTUREDEFINITION_PRACTITIONERROLE = require("./resources/StructureDefinition-PractitionerRole")
  ...
  axios.__setFhirResults( DEFAULT_URL + "StructureDefinition/PractitionerRole", null, 
  ...
  test( 'test setQuestionnairePaths', () => {
    ...
    const MOCK_QUESTIONNAIRE_RESPONSE = require("./resources/QuestionnaireResponse-ihris-test")
