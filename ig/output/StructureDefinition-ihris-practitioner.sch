...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Practitioner">
      <sch:assert test="count(f:extension[@url = 'http://ihris.org/fhir/StructureDefinition/ihris-practitioner-residence']) &lt;= 1">extension with URL = 'http://ihris.org/fhir/StructureDefinition/ihris-practitioner-residence': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://ihris.org/fhir/StructureDefinition/ihris-practitioner-nationality']) &lt;= 1">extension with URL = 'http://ihris.org/fhir/StructureDefinition/ihris-practitioner-nationality': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://ihris.org/fhir/StructureDefinition/ihris-practitioner-marital-status']) &lt;= 1">extension with URL = 'http://ihris.org/fhir/StructureDefinition/ihris-practitioner-marital-status': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://ihris.org/fhir/StructureDefinition/ihris-practitioner-dependents']) &lt;= 1">extension with URL = 'http://ihris.org/fhir/StructureDefinition/ihris-practitioner-dependents': maximum cardinality of 'extension' is 1</sch:assert>
