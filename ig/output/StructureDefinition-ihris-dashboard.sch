...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Basic">
      ...
      <sch:assert test="count(f:extension[@url = 'http://ihris.org/fhir/StructureDefinition/ihris-dashboard-visualization']) &gt;= 1">extension with URL = 'http://ihris.org/fhir/StructureDefinition/ihris-dashboard-visualization': minimum cardinality of 'extension' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
</sch:schema>
