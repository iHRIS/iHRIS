...
* parameter[=].valueSignature.when = "2022-01-19T14:56:26.715Z"
* parameter[=].valueSignature.who = Reference(http://ihris.org/fhir/Organization/ihris)
* parameter[=].valueSignature.data = "YNliaMsQqXlm3abaxMWtYFKJXOQsNEI343cbrz16HRRvyHGnnSZXWmvbgwD8/lZDTLEKMO8zXPV8Y8eQr2J/YaS5jSr+dIZ/Ky0ZrCcUGmEn18MQpJMyhNT+yVUJjscOOjV+uT178pE5aURIQIhLodT8j+F/vH408czSyWjEEA4="
...
* parameter[0].name = "signature"
* parameter[=].valueSignature.type = urn:iso-astm:E1762-95:2013#1.2.840.10065.1.12.1.14
* parameter[=].valueSignature.when = "2022-06-13T14:02:21.608Z"
* parameter[=].valueSignature.who = Reference(http://ihris.org/fhir/Organization/ihris)
* parameter[=].valueSignature.data = "kNyE86/sFakqZVQLbWug58S2/pVBLYmiALYRFSChgcesdrwFfe9CshMMcSMV/W7rphTV/uS/ZD3LDlr3xO2PyiVsNa2O+i5uvexGtVWegY74vnvrTaeK/H9kT2xWHRXC5R8nl4TY4N3rosqPjacSrYXPwYER/kunqag8QPWb/II="
* parameter[+].name = "config"
* parameter[=].part[0].name = "site:title"
* parameter[=].part[=].valueString = "Manage"
* parameter[=].part[+].name = "site:site"
