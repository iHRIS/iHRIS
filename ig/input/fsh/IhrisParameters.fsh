...
* parameter[=].part[=].valueString = "tree"
* parameter[=].part[+].name = "defaults:fields:Location.extension:facilityLocation.value[x]:valueReference:initialValue"
* parameter[=].part[=].valueString = "Location/ET"
* parameter[=].part[+].name = "defaults:fields:Location.partOf:initialValue"
* parameter[=].part[=].valueString = "Location/federal-ministry-of-health"
