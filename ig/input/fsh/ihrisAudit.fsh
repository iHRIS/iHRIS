...
* extension[display].extension[search][1].valueString = "User|AuditEvent.agent.name"
* extension[display].extension[search][2].valueString = "Action|AuditEvent.subtype.display"
* extension[display].extension[search][3].valueString = "Resource|AuditEvent.entity.what.reference"
* extension[display].extension[search][4].valueString = "Outcome|AuditEvent.outcome"
* extension[display].extension[search][5].valueString = "Resource(If Error)|AuditEvent.entity.detail.where(type='resource').valueString"
* extension[display].extension[search][6].valueString = "Error|AuditEvent.entity.detail.where(type='error').valueString"
* extension[display].extension[search][7].valueString = "Time/Date|AuditEvent.recorded"
...
* extension[display].extension[filter][1].valueString = "Date|date"
