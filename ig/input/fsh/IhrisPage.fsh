...
* extension[display].extension[search][5].valueString = "Place of Work|Practitioner.address.where(use='work').text"
* extension[display].extension[search][6].valueString = "National ID(NIN) |identifier.where(type.coding.where(code='nin')).value"
* extension[display].extension[search][7].valueString = "Active|Practitioner.active"
* extension[display].extension[search][8].valueString = "Phone|Practitioner.telecom.where(system='phone').value"
* extension[display].extension[search][9].valueString = "Email|Practitioner.telecom.where(system='email').value"
* extension[display].extension[search][10].valueString = "Qualification|Practitioner.qualification.code.text"
* extension[display].extension[search][11].valueString = "Facility|Practitioner.extension.where(url='http://ihris.org/fhir/StructureDefinition/ihris-practitioner-facility').valueString"
* extension[display].extension[search][12].valueString = "District|address.district"
* extension[display].extension[search][13].valueString = "Region|Practitioner.extension.where(url='http://ihris.org/fhir/StructureDefinition/ihris-practitioner-region').valueString"
...
* extension[display].extension[filter][6].valueString = "Facility|Practitioner.extension.where(url='http://ihris.org/fhir/StructureDefinition/ihris-practitioner-facility').valueString"
* extension[display].extension[filter][7].valueString = "District|address:contains"
* extension[display].extension[filter][8].valueString = "Region|Practitioner.extension.where(url='http://ihris.org/fhir/StructureDefinition/ihris-practitioner-region').valueString"
