...
* extension[display].extension[search][4].valueString = "Place of Work|Practitioner.address.where(use='work').text"
...
* extension[display].extension[filter][3].valueString = "BirthDate|birthDate"
* extension[display].extension[filter][4].valueString = "Place Of Work|Practitioner.address.where(use='work').text"
...
* extension[display].extension[search][1].valueString = "Action|AuditEvent.subtype.display"
...
* extension[display].extension[search][4].valueString = "Agent|AuditEvent.agent.name"
* extension[display].extension[search][5].valueString = "What|AuditEvent.entity.what.reference"
* extension[display].extension[filter][0].valueString = "Recorded|date"
* extension[display].extension[filter][1].valueString = "Outcome|outcome"
* extension[display].extension[filter][2].valueString = "What|entity"
